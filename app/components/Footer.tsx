...
function Footer() {
  return (
    <footer className="flexCenter mb-24">
      <div className="padding-container max-container flex flex-col w-full gap-14 py-20">
        ...
        <div className="border bg-gray-20" />
          <p className="regular-14 text-gray-30 text-center w-full">2024 Hilink | All Rights Reserved</p>
      </div>
    </footer>
  );
}
